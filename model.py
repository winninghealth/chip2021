# -*- coding: utf-8 -*-
"""
Created on Fri Sep 24 13:42:13 2021
...
class ClinicalFindingsClassificationModel(Model):
    def __init__(
        ...
        **kwargs,
        ...
        self.cls_head = ClassificationHead(input_dim=self.bert.config.hidden_size,
                                           inner_dim=self.bert.config.hidden_size,
    ...
    def forward(
        ...
        # encoder
        enc_hidden_states = outputs.last_hidden_state
